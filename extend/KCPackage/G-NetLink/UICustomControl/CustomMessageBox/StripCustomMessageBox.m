...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _lbl_text = [[UILabel alloc] initWithFrame:CGRectMake(10,frame.size.height/2-10,frame.size.width-60, 20)];
        ...
        _lbl_text.font = [UIFont systemFontOfSize:13];
        _lbl_text.textColor = [UIColor whiteColor];
        [self addSubview:_lbl_text];
        
        _btn_close=[[UIHyperlinksButton alloc]initWithFrame:CGRectMake(_lbl_text.frame.origin.x+_lbl_text.frame.size.width,_lbl_text.frame.origin.y,50,20)];
