...
@implementation DeleteNotificationsBusiness
-(id)init
{
    if (self = [super initWithNtspHeader]) {
        self.businessId = BUSINESS_NOTIFICATIONNEWS_DELETE;
        NSString *ip = API_ADDRESS;
        ip = [ip stringByAppendingString:@"system/sendmsg/delete"];
